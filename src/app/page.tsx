...
const products = [
  {
    id: 1,
    name: 'Tablete Intenso 70%',
    badge: 'MAIS VENDIDO',
    badgeColor: '#C8860A',
    price: 28.90,
    weight: '80g',
    description: 'Cacau intenso com notas de frutas vermelhas e finalização longa. Para quem leva chocolate a sério.',
    image: '/images/tablete-intenso.png',
    stock: 42,
  },
  {
    id: 2,
    name: 'Tablete Avelã & Caramelo',
    badge: 'NOVO',
    badgeColor: '#D4A017',
    price: 32.90,
    weight: '80g',
    description: 'Chocolate ao leite cremoso com avelãs inteiras tostadas e swirl de caramelo artesanal.',
    image: '/images/tablete-avela-caramelo.png',
    stock: 18,
  },
  {
    id: 3,
    name: 'Tablete Branco Pistache',
    badge: 'EDIÇÃO LIMITADA',
    badgeColor: '#25D366',
    price: 34.90,
    weight: '80g',
    description: 'Chocolate branco premium com pistache siciliano e flor de sal. Delicado e surpreendente.',
    image: '/images/tablete-pistache.png',
    stock: 7,
  },
  {
    id: 4,
    name: 'Ovo de Páscoa Trufa Belga',
    badge: 'PÁSCOA 2026',
    badgeColor: '#C8860A',
    price: 89.90,
    weight: '350g',
    description: 'Casca de chocolate 60% cacau recheada com trufas belgas artesanais. Embalagem presente incluída.',
    image: '/images/ovo-trufa-belga.png',
    stock: 25,
  },
  {
    id: 5,
    name: 'Ovo de Páscoa Branco com Morango',
    badge: 'PÁSCOA 2026',
    badgeColor: '#D88498',
    price: 79.90,
    weight: '300g',
    description: 'Chocolate branco com recheio de mousse de morango e pedaços de morango liofilizado.',
    image: '/images/ovo-morango.png',
    stock: 0,
  },
  {
    id: 6,
    name: 'Ovo de Páscoa Meio Amargo Recheado',
    badge: 'PÁSCOA 2026',
    badgeColor: '#C8860A',
    price: 84.90,
    weight: '400g',
    description: 'Casca de chocolate meio amargo 55% recheada com ganache aveludada e avelãs caramelizadas. O presente perfeito para a Páscoa.',
    image: '/images/ovo-meio-amargo.png',
    stock: 13,
  },
  {
    id: 7,
